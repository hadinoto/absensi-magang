          ...
          <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                ...
                <a class="btn btn-primary mb-2 col-lg-2" href="?hal=tambah_peserta" aria-expanded="false" style="margin: 0px 2px 0px 2px;">+ Tambah Peseerta </a>
                ...
                <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <?php
                    $no = 1;
                    $query = "SELECT * FROM peserta WHERE confirm = '0'";
